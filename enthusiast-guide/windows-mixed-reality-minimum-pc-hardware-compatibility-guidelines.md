...
**HP 回音相容規格**<br>
因為解析度較高，所以下列需求適用于 HP 回條 G1 & G2 產品線，以確保最佳的 90 Hz、完整解析度體驗： 
...
為了在 Surface 裝置上獲得最佳 Windows Mixed Reality 體驗，我們建議使用 NVIDIA GeForce GTX 1060 GB 和 16 GB RAM 設定 SurfaceBook 2 () 15」。  此設定支援所有的 Windows Mixed Reality 功能 @ 90 Hz，並已針對 Windows Mixed Reality Ultra 進行過測試和徽章。  Surface Book 2 (13 ") 、Surface Studio、Surface Laptop 和 Surface Pro (2017) 將在設定 Intel Core i5 CPU Windows Mixed Reality 或更好的 (，以及至少 8 GB 的 RAM 時，支援一些) 功能。
...
<tr>
        ...
        <td>
            <ul>
                <li><b>建議</b>：若要在 Surface 裝置上獲得最佳 Windows Mixed Reality 體驗，建議使用 NVIDIA GeForce GTX 1060 gb 和 16 GB RAM 設定 SurfaceBook 2 15」。  這項設定經過測試並徽章為 Windows Mixed Reality Ultra 因此將支援所有 Windows Mixed Reality 功能，並可讓您享受最廣泛的相容應用程式和遊戲陣列。</li>
                <li>NVIDIA GeForce GTX 1060 離散 GPU 將提供 Windows Mixed Reality Ultra @ 90-Hz 體驗</li><br/>                <li>為了達到最佳效能，請使用針對 Surface Book 2 發行的 Nvidia 圖形驅動程式。 新的驅動程式可能適用于 Nvidia&#39;的網站，但尚未測試。</li><br/>                <li>需要 <a href="https://www.microsoft.com/en-us/store/d/surface-usb-c-to-hdmi-adapter/94chb2m80s54/4gj5">SURFACE USB-C 至 HDMI 介面卡</a> (其他介面卡可能可以運作，但尚未測試) </li>
                <li><b>注意：在 Surface dock 上</b>：由於 surface dock 的電源供應限制，Surface Book 2 的介面停駐使用未正式支援 Windows Mixed Reality。</li><br/>                <li><b>請注意 Windows 10 版本 1803</b>：如果您&#39;重新執行 Windows 10 1803 版，請確定您&#39;在 KB4284848 (所安裝的 OS 組建17134.137 或更新版本) 上，確定您有最新的效能修正。 如需詳細資訊，請參閱 <a href="https://support.microsoft.com/en-us/help/4284848/windows-10-update-kb4284848">KB4284848</a>的版本資訊。</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                ...
                <li>具有 Intel Core i5/Intel HD Graphics 620 整合式 GPU 的設定將提供 Windows Mixed Reality @ 60-Hz 體驗</li>
                <li>具有 Intel 核心 i7/NVIDIA GeForce GTX 1050 離散 GPU 的設定將會提供 Windows Mixed Reality @ 90-Hz 體驗</li>                       <li>為了達到最佳效能，請使用針對 Surface Book 2 發行的 Nvidia 圖形驅動程式。 新的驅動程式可能適用于 Nvidia&#39;的網站，但尚未測試。</li>
                ...
                <li><b>注意：在 Surface dock 上</b>：由於 surface dock 的電源供應限制，Surface Book 2 的介面停駐使用未正式支援 Windows Mixed Reality。</li>
                <li><b>請注意 Windows 10 版本 1803</b>：如果您&#39;重新執行 Windows 10 1803 版，請確定您&#39;在 KB4284848 (所安裝的 OS 組建17134.137 或更新版本) 上，確定您有最新的效能修正。 如需詳細資訊，請參閱 <a href="https://support.microsoft.com/en-us/help/4284848/windows-10-update-kb4284848">KB4284848</a>的版本資訊。</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                ...
                <li>NVIDIA GeForce GTX 965 m 的設定將會提供 Windows Mixed Reality @ 60-Hz 體驗。</li>
                <li>NVIDIA GeForce GTX 980 m 的設定將會提供 Windows Mixed Reality @ 90-Hz 體驗。</li>
    ...
    <tr>
        ...
        <td>
            <ul>
                ...
                <li>具有 Intel Core i5/Intel HD Graphics 620 整合式 GPU 的設定將提供 Windows Mixed Reality @ 60-Hz 體驗</li>
                <li>具有 Intel 核心 i7/Intel®鳶尾花™加上圖形640整合式 GPU 的設定將提供 Windows Mixed Reality @ 60-Hz 體驗</li><br/><li>需要 Surface 迷你 DisplayPort 至 HDMI 2.0 介面卡 (其他介面卡仍可運作，但未經過測試) </li>
