...
|  Checkpoint  |  結果  |
| --- | --- |
| [最低電腦硬體指導方針](windows-mixed-reality-minimum-pc-hardware-compatibility-guidelines.md) | 執行 Windows Mixed Reality、Windows Mixed Reality Ultra 和混合實境入口應用程式所需瞭解的一切 |
...
* [移動控制器的運作方式](motion-controllers.md)
