...
## <a name="setting-up-project-for-the-oculus-quest"></a><span data-ttu-id="5b1a6-113">設定專案以進行 Oculus 的尋找</span><span class="sxs-lookup"><span data-stu-id="5b1a6-113">Setting up project for the Oculus Quest</span></span>
