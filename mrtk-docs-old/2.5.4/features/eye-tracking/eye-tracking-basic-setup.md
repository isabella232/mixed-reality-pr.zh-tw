...
2. 請務必勾選 [_功能_] 下的 [ _GazeInput_ ] 核取方塊。 如果您沒有看到「 _GazeInput_ 」功能，請確認您的系統符合 [使用 MRTK](../../install-the-tools.md#prerequisites) (的必要條件，特別是 Windows SDK 版本) 。
...
別忘了看看 [我們的 MRTK 眼睛追蹤教學課程和範例，](eye-tracking-examples-overview.md) 示範如何使用眼睛追蹤輸入，並以便利的方式提供可在專案中重複使用的腳本。
