...
1. 確定已在主要 [MRTK 設定檔](../../configuration/MixedRealityConfigurationGuide.md)中註冊相關的指標。
...
> ![NearInteractionTouchable Gizmos 範例2](../images/input/pointers/NearInteractionTouchableGizmos.png)
