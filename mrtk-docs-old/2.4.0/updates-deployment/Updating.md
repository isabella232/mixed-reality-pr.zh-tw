...
1. <span data-ttu-id="6f96c-135">匯入新的 unity 套件</span><span class="sxs-lookup"><span data-stu-id="6f96c-135">Import the new unity packages</span></span>
    ...
    - <span data-ttu-id="6f96c-138"> (選用) 擴充功能</span><span class="sxs-lookup"><span data-stu-id="6f96c-138">(Optional) Extensions</span></span>
    > [!NOTE]
...
## <a name="updating-230-to-240"></a><span data-ttu-id="6f96c-161">將2.3.0 更新為2.4。0</span><span class="sxs-lookup"><span data-stu-id="6f96c-161">Updating 2.3.0 to 2.4.0</span></span>
...
<span data-ttu-id="6f96c-189">如需有關這些變更的詳細資訊，以及適用于眼睛追蹤設定的完整指示，請參閱 [眼睛追蹤](../features/EyeTracking/EyeTracking_BasicSetup.md) 文章。</span><span class="sxs-lookup"><span data-stu-id="6f96c-189">For more information on these changes and complete instructions for eye tracking setup, please see the [eye tracking](../features/EyeTracking/EyeTracking_BasicSetup.md) article.</span></span>
...
<span data-ttu-id="6f96c-238">雖然現有的程式碼在版本2.3.0 中仍可繼續運作，但建議您更新至新的類別。</span><span class="sxs-lookup"><span data-stu-id="6f96c-238">While existing code will continue to function in version 2.3.0, it is recommended to update to the new class.</span></span>
...
<span data-ttu-id="6f96c-259">應用程式程式碼可能會因為這種變更而需要更新。</span><span class="sxs-lookup"><span data-stu-id="6f96c-259">Application code may require updating due to this change.</span></span>
...
- [<span data-ttu-id="6f96c-275">API 變更</span><span class="sxs-lookup"><span data-stu-id="6f96c-275">API changes</span></span>](#api-changes-in-210)
...
<span data-ttu-id="6f96c-293">**互動**</span><span class="sxs-lookup"><span data-stu-id="6f96c-293">**Interactable**</span></span>
...
<span data-ttu-id="6f96c-340">**MixedRealityToolkit**</span><span class="sxs-lookup"><span data-stu-id="6f96c-340">**MixedRealityToolkit**</span></span>
...
<span data-ttu-id="6f96c-350">使用新的 CoreSystem 類別可確保您的應用程式程式碼在您將應用程式變更為使用不同的服務註冊機構時，不需要更新 (例如：其中一個實驗性服務管理員) 。</span><span class="sxs-lookup"><span data-stu-id="6f96c-350">Using the new CoreSystem class will ensure that your application code will not need updating if you change the application to use a different service registrar (ex: one of the experimental service managers).</span></span>
...
<span data-ttu-id="6f96c-369">新 `RegisterHandler` 的 API 和 `UnregisterHandler` ：</span><span class="sxs-lookup"><span data-stu-id="6f96c-369">New API `RegisterHandler` and `UnregisterHandler`:</span></span>
...
<span data-ttu-id="6f96c-382">IMixedRealitySpatialAwarenessSystem 和 IMixedRealitySpatialAwarenessObserver 介面採用多個中斷變更，如下所述。</span><span class="sxs-lookup"><span data-stu-id="6f96c-382">The IMixedRealitySpatialAwarenessSystem and IMixedRealitySpatialAwarenessObserver interfaces have taken multiple breaking changes as described below.</span></span>
...
<span data-ttu-id="6f96c-400">**_SurfaceMagnetism_**</span><span class="sxs-lookup"><span data-stu-id="6f96c-400">**_SurfaceMagnetism_**</span></span>
...
<span data-ttu-id="6f96c-428">HoloLens clicker 的控制器對應已從狀況變更 [`WindowsMixedRealityController`](xref:Microsoft.MixedReality.Toolkit.WindowsMixedReality.Input.WindowsMixedRealityController) 為狀況 [`WindowsMixedRealityGGVHand`](xref:Microsoft.MixedReality.Toolkit.WindowsMixedReality.Input.WindowsMixedRealityGGVHand) 。</span><span class="sxs-lookup"><span data-stu-id="6f96c-428">The HoloLens clicker's controller mappings have changed from being an unhanded [`WindowsMixedRealityController`](xref:Microsoft.MixedReality.Toolkit.WindowsMixedReality.Input.WindowsMixedRealityController) to being an unhanded [`WindowsMixedRealityGGVHand`](xref:Microsoft.MixedReality.Toolkit.WindowsMixedReality.Input.WindowsMixedRealityGGVHand).</span></span> <span data-ttu-id="6f96c-429">為了因應此情況，當您第一次開啟 ControllerMapping 設定檔時，會執行自動更新程式。</span><span class="sxs-lookup"><span data-stu-id="6f96c-429">To account for this, an automatic updater will run the first time you open your ControllerMapping profile.</span></span> <span data-ttu-id="6f96c-430">請至少在升級至2.0.0 之後開啟任何自訂設定檔一次，以觸發這個一次性的遷移步驟。</span><span class="sxs-lookup"><span data-stu-id="6f96c-430">Please open any custom profiles at least once after upgrading to 2.0.0 in order to trigger this one-time migration step.</span></span>

<span data-ttu-id="6f96c-431">**InteractableHighlight**</span><span class="sxs-lookup"><span data-stu-id="6f96c-431">**InteractableHighlight**</span></span>

<span data-ttu-id="6f96c-432">`InteractableHighlight` 類別已被取代。</span><span class="sxs-lookup"><span data-stu-id="6f96c-432">The `InteractableHighlight` class has been deprecated.</span></span> <span data-ttu-id="6f96c-433">`InteractableOnFocus` `FocusInteractableStates` 應改為使用類別和資產。</span><span class="sxs-lookup"><span data-stu-id="6f96c-433">The `InteractableOnFocus` class and `FocusInteractableStates` asset should be used instead.</span></span> <span data-ttu-id="6f96c-434">若要為建立新的 `Theme` 資產 `InteractableOnFocus` ，請在 [專案] 視窗中按一下滑鼠右鍵，然後選取 [*建立*  >  *混合現實工具* 組  >  *互動*  >  *主題*]。</span><span class="sxs-lookup"><span data-stu-id="6f96c-434">To create a new `Theme` asset for the `InteractableOnFocus`, right click in the project window and select *Create* > *Mixed Reality Toolkit* > *Interactable* > *Theme*.</span></span>

<span data-ttu-id="6f96c-435">**HandInteractionPanZoom**</span><span class="sxs-lookup"><span data-stu-id="6f96c-435">**HandInteractionPanZoom**</span></span>

<span data-ttu-id="6f96c-436">`HandInteractionPanZoom` 已移至 UI 命名空間，因為它不是輸入元件。</span><span class="sxs-lookup"><span data-stu-id="6f96c-436">`HandInteractionPanZoom` has been moved to the UI namespace as it was not an input component.</span></span> <span data-ttu-id="6f96c-437">`HandPanEventData` 也已移至此命名空間，並簡化為與其他 UI 事件資料對應。</span><span class="sxs-lookup"><span data-stu-id="6f96c-437">`HandPanEventData` has also been moved into this namespace, and simplified to correspond with other UI event data.</span></span>

### <a name="assembly-name-changes-in-200"></a><span data-ttu-id="6f96c-438">2.0.0 中的元件名稱變更</span><span class="sxs-lookup"><span data-stu-id="6f96c-438">Assembly name changes in 2.0.0</span></span>

<span data-ttu-id="6f96c-439">在2.0.0 版本中，所有的官方混合現實工具組元件名稱及其相關聯的元件定義 (. asmdef) 檔案都已更新為符合下列模式。</span><span class="sxs-lookup"><span data-stu-id="6f96c-439">In The 2.0.0 release, all of the official Mixed Reality Toolkit assembly names and their associated assembly definition (.asmdef) files have been updated to fit the following pattern.</span></span>

```c#
Microsoft.MixedReality.Toolkit[.<name>]
```

<span data-ttu-id="6f96c-440">在某些情況下，已合併多個元件以建立更好的 unity 內容。</span><span class="sxs-lookup"><span data-stu-id="6f96c-440">In some instances, multiple assemblies have been merged to create better unity of their contents.</span></span> <span data-ttu-id="6f96c-441">如果您的專案使用自訂的 asmdef 檔案，則可能需要更新。</span><span class="sxs-lookup"><span data-stu-id="6f96c-441">If your project uses custom .asmdef files, they may require updating.</span></span>

<span data-ttu-id="6f96c-442">下表說明 RC2 asmdef 檔案名如何對應至2.0.0 版本。</span><span class="sxs-lookup"><span data-stu-id="6f96c-442">The following tables describe how the RC2 .asmdef file names map to the 2.0.0 release.</span></span> <span data-ttu-id="6f96c-443">所有元件名稱都符合 asmdef 檔案名。</span><span class="sxs-lookup"><span data-stu-id="6f96c-443">All assembly names match the .asmdef file name.</span></span>

<span data-ttu-id="6f96c-444">**MixedRealityToolkit**</span><span class="sxs-lookup"><span data-stu-id="6f96c-444">**MixedRealityToolkit**</span></span>

| <span data-ttu-id="6f96c-445">RC2</span><span class="sxs-lookup"><span data-stu-id="6f96c-445">RC2</span></span> | <span data-ttu-id="6f96c-446">2.0.0</span><span class="sxs-lookup"><span data-stu-id="6f96c-446">2.0.0</span></span> |
| --- | --- |
| <span data-ttu-id="6f96c-447">MixedRealityToolkit.asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-447">MixedRealityToolkit.asmdef</span></span> | <span data-ttu-id="6f96c-448">MixedReality 工具組. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-448">Microsoft.MixedReality.Toolkit.asmdef</span></span> |
| <span data-ttu-id="6f96c-449">MixedRealityToolkit. BuildAndDeploy. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-449">MixedRealityToolkit.Core.BuildAndDeploy.asmdef</span></span> | <span data-ttu-id="6f96c-450">MixedReality. BuildAndDeploy. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-450">Microsoft.MixedReality.Toolkit.Editor.BuildAndDeploy.asmdef</span></span> |
| <span data-ttu-id="6f96c-451">MixedRealityToolkit，asmdef 的</span><span class="sxs-lookup"><span data-stu-id="6f96c-451">MixedRealityToolkit.Core.Definitions.Utilities.Editor.asmdef</span></span> | <span data-ttu-id="6f96c-452">已移除，請使用 MixedReality 工具組。 asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-452">Removed, use Microsoft.MixedReality.Toolkit.Editor.Utilities.asmdef</span></span> |
| <span data-ttu-id="6f96c-453">MixedRealityToolkit. EditorClassExtensions. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-453">MixedRealityToolkit.Core.Extensions.EditorClassExtensions.asmdef</span></span> | <span data-ttu-id="6f96c-454">MixedReality. ClassExtensions. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-454">Microsoft.MixedReality.Toolkit.Editor.ClassExtensions.asmdef</span></span>
| <span data-ttu-id="6f96c-455">MixedRealityToolkit asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-455">MixedRealityToolkit.Core.Inspectors.asmdef</span></span> | <span data-ttu-id="6f96c-456">MixedReality. asmdef。</span><span class="sxs-lookup"><span data-stu-id="6f96c-456">Microsoft.MixedReality.Toolkit.Editor.Inspectors.asmdef</span></span> |
| <span data-ttu-id="6f96c-457">MixedRealityToolkit ServiceInspectors. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-457">MixedRealityToolkit.Core.Inspectors.ServiceInspectors.asmdef</span></span> | <span data-ttu-id="6f96c-458">MixedReality. ServiceInspectors. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-458">Microsoft.MixedReality.Toolkit.Editor.ServiceInspectors.asmdef</span></span> |
| <span data-ttu-id="6f96c-459">MixedRealityToolkit. UtilitiesAsync. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-459">MixedRealityToolkit.Core.UtilitiesAsync.asmdef</span></span> | <span data-ttu-id="6f96c-460">MixedReality. asmdef。</span><span class="sxs-lookup"><span data-stu-id="6f96c-460">Microsoft.MixedReality.Toolkit.Async.asmdef</span></span> |
| <span data-ttu-id="6f96c-461">Asmdef 的 MixedRealityToolkit。</span><span class="sxs-lookup"><span data-stu-id="6f96c-461">MixedRealityToolkit.Core.Utilities.Editor.asmdef</span></span> | <span data-ttu-id="6f96c-462">MixedReality 工具組。 asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-462">Microsoft.MixedReality.Toolkit.Editor.Utilities.asmdef</span></span> |
| <span data-ttu-id="6f96c-463">MixedRealityToolkit Gltf. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-463">MixedRealityToolkit.Utilities.Gltf.asmdef</span></span> | <span data-ttu-id="6f96c-464">MixedReality. Gltf. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-464">Microsoft.MixedReality.Toolkit.Gltf.asmdef</span></span> |
| <span data-ttu-id="6f96c-465">MixedRealityToolkit，Gltf asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-465">MixedRealityToolkit.Utilities.Gltf.Importers.asmdef</span></span> | <span data-ttu-id="6f96c-466">MixedReality. Gltf. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-466">Microsoft.MixedReality.Toolkit.Gltf.Importers.asmdef</span></span> |

<span data-ttu-id="6f96c-467">**MixedRealityToolkit。提供者**</span><span class="sxs-lookup"><span data-stu-id="6f96c-467">**MixedRealityToolkit.Providers**</span></span>

| <span data-ttu-id="6f96c-468">RC2</span><span class="sxs-lookup"><span data-stu-id="6f96c-468">RC2</span></span> | <span data-ttu-id="6f96c-469">2.0.0</span><span class="sxs-lookup"><span data-stu-id="6f96c-469">2.0.0</span></span> |
| --- | --- |
| <span data-ttu-id="6f96c-470">MixedRealityToolkit. OpenVR. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-470">MixedRealityToolkit.Providers.OpenVR.asmdef</span></span> | <span data-ttu-id="6f96c-471">MixedReality. OpenVR. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-471">Microsoft.MixedReality.Toolkit.Providers.OpenVR.asmdef</span></span> |
| <span data-ttu-id="6f96c-472">MixedRealityToolkit. WindowsMixedReality. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-472">MixedRealityToolkit.Providers.WindowsMixedReality.asmdef</span></span> | <span data-ttu-id="6f96c-473">MixedReality. WindowsMixedReality. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-473">Microsoft.MixedReality.Toolkit.Providers.WindowsMixedReality.asmdef</span></span> |
| <span data-ttu-id="6f96c-474">MixedRealityToolkit. WindowsVoiceInput. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-474">MixedRealityToolkit.Providers.WindowsVoiceInput.asmdef</span></span> | <span data-ttu-id="6f96c-475">MixedReality. WindowsVoiceInput. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-475">Microsoft.MixedReality.Toolkit.Providers.WindowsVoiceInput.asmdef</span></span> |

<span data-ttu-id="6f96c-476">**MixedRealityToolkit 服務**</span><span class="sxs-lookup"><span data-stu-id="6f96c-476">**MixedRealityToolkit.Services**</span></span>

| <span data-ttu-id="6f96c-477">RC2</span><span class="sxs-lookup"><span data-stu-id="6f96c-477">RC2</span></span> | <span data-ttu-id="6f96c-478">2.0.0</span><span class="sxs-lookup"><span data-stu-id="6f96c-478">2.0.0</span></span> |
| --- | --- |
| <span data-ttu-id="6f96c-479">MixedRealityToolkit. BoundarySystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-479">MixedRealityToolkit.Services.BoundarySystem.asmdef</span></span> | <span data-ttu-id="6f96c-480">MixedReality. BoundarySystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-480">Microsoft.MixedReality.Toolkit.Services.BoundarySystem.asmdef</span></span> |
| <span data-ttu-id="6f96c-481">MixedRealityToolkit. CameraSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-481">MixedRealityToolkit.Services.CameraSystem.asmdef</span></span> | <span data-ttu-id="6f96c-482">MixedReality. CameraSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-482">Microsoft.MixedReality.Toolkit.Services.CameraSystem.asmdef</span></span> |
| <span data-ttu-id="6f96c-483">MixedRealityToolkit. DiagnosticsSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-483">MixedRealityToolkit.Services.DiagnosticsSystem.asmdef</span></span> | <span data-ttu-id="6f96c-484">MixedReality. DiagnosticsSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-484">Microsoft.MixedReality.Toolkit.Services.DiagnosticsSystem.asmdef</span></span> |
| <span data-ttu-id="6f96c-485">MixedRealityToolkit. InputSimulation. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-485">MixedRealityToolkit.Services.InputSimulation.asmdef</span></span> | <span data-ttu-id="6f96c-486">MixedReality. InputSimulation. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-486">Microsoft.MixedReality.Toolkit.Services.InputSimulation.asmdef</span></span> |
| <span data-ttu-id="6f96c-487">MixedRealityToolkit. InputSimulation. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-487">MixedRealityToolkit.Services.InputSimulation.Editor.asmdef</span></span> | <span data-ttu-id="6f96c-488">MixedReality. InputSimulation. asmdef。</span><span class="sxs-lookup"><span data-stu-id="6f96c-488">Microsoft.MixedReality.Toolkit.Services.InputSimulation.Editor.asmdef</span></span> |
| <span data-ttu-id="6f96c-489">MixedRealityToolkit. InputSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-489">MixedRealityToolkit.Services.InputSystem.asmdef</span></span> | <span data-ttu-id="6f96c-490">MixedReality. InputSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-490">Microsoft.MixedReality.Toolkit.Services.InputSystem.asmdef</span></span> |
| <span data-ttu-id="6f96c-491">MixedRealityToolkit asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-491">MixedRealityToolkit.Services.Inspectors.asmdef</span></span> | <span data-ttu-id="6f96c-492">MixedReality. InputSystem. asmdef。</span><span class="sxs-lookup"><span data-stu-id="6f96c-492">Microsoft.MixedReality.Toolkit.Services.InputSystem.Editor.asmdef</span></span> |
| <span data-ttu-id="6f96c-493">MixedRealityToolkit. SceneSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-493">MixedRealityToolkit.Services.SceneSystem.asmdef</span></span> | <span data-ttu-id="6f96c-494">MixedReality. SceneSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-494">Microsoft.MixedReality.Toolkit.Services.SceneSystem.asmdef</span></span> |
| <span data-ttu-id="6f96c-495">MixedRealityToolkit. SpatialAwarenessSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-495">MixedRealityToolkit.Services.SpatialAwarenessSystem.asmdef</span></span> | <span data-ttu-id="6f96c-496">MixedReality. SpatialAwarenessSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-496">Microsoft.MixedReality.Toolkit.Services.SpatialAwarenessSystem.asmdef</span></span> |
| <span data-ttu-id="6f96c-497">MixedRealityToolkit. TeleportSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-497">MixedRealityToolkit.Services.TeleportSystem.asmdef</span></span> | <span data-ttu-id="6f96c-498">MixedReality. TeleportSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-498">Microsoft.MixedReality.Toolkit.Services.TeleportSystem.asmdef</span></span> |

<span data-ttu-id="6f96c-499">**MixedRealityToolkit SDK**</span><span class="sxs-lookup"><span data-stu-id="6f96c-499">**MixedRealityToolkit.SDK**</span></span>

| <span data-ttu-id="6f96c-500">RC2</span><span class="sxs-lookup"><span data-stu-id="6f96c-500">RC2</span></span> | <span data-ttu-id="6f96c-501">2.0.0</span><span class="sxs-lookup"><span data-stu-id="6f96c-501">2.0.0</span></span> |
| --- | --- |
| <span data-ttu-id="6f96c-502">MixedRealityToolkit. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-502">MixedRealityToolkit.SDK.asmdef</span></span> | <span data-ttu-id="6f96c-503">MixedReality 工具組. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-503">Microsoft.MixedReality.Toolkit.SDK.asmdef</span></span> |
| <span data-ttu-id="6f96c-504">MixedRealityToolkit asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-504">MixedRealityToolkit.SDK.Inspectors.asmdef</span></span> | <span data-ttu-id="6f96c-505">MixedReality 工具組. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-505">Microsoft.MixedReality.Toolkit.SDK.Inspectors.asmdef</span></span> |

<span data-ttu-id="6f96c-506">**MixedRealityToolkit 範例**</span><span class="sxs-lookup"><span data-stu-id="6f96c-506">**MixedRealityToolkit.Examples**</span></span>

| <span data-ttu-id="6f96c-507">RC2</span><span class="sxs-lookup"><span data-stu-id="6f96c-507">RC2</span></span> | <span data-ttu-id="6f96c-508">2.0.0</span><span class="sxs-lookup"><span data-stu-id="6f96c-508">2.0.0</span></span> |
| --- | --- |
| <span data-ttu-id="6f96c-509">MixedRealityToolkit。例如 asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-509">MixedRealityToolkit.Examples.asmdef</span></span> | <span data-ttu-id="6f96c-510">MixedReality，例如 asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-510">Microsoft.MixedReality.Toolkit.Examples.asmdef</span></span> |
| <span data-ttu-id="6f96c-511">MixedRealityToolkit. Gltf. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-511">MixedRealityToolkit.Examples.Demos.Gltf.asmdef</span></span> | <span data-ttu-id="6f96c-512">MixedReality. Gltf. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-512">Microsoft.MixedReality.Toolkit.Demos.Gltf.asmdef</span></span> |
| <span data-ttu-id="6f96c-513">MixedRealityToolkit，例如 StandardShader asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-513">MixedRealityToolkit.Examples.Demos.StandardShader.Inspectors.asmdef</span></span> | <span data-ttu-id="6f96c-514">MixedReality. StandardShader. asmdef。</span><span class="sxs-lookup"><span data-stu-id="6f96c-514">Microsoft.MixedReality.Toolkit.Demos.StandardShader.Inspectors.asmdef</span></span> |
| <span data-ttu-id="6f96c-515">MixedRealityToolkit，InspectorFields. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-515">MixedRealityToolkit.Examples.Demos.Utilities.InspectorFields.asmdef</span></span> | <span data-ttu-id="6f96c-516">MixedReality. InspectorFields. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-516">Microsoft.MixedReality.Toolkit.Demos.InspectorFields.asmdef</span></span> |
| <span data-ttu-id="6f96c-517">MixedRealityToolkit，例如 InspectorFields asmdef。</span><span class="sxs-lookup"><span data-stu-id="6f96c-517">MixedRealityToolkit.Examples.Demos.Utilities.InspectorFields.Inspectors.asmdef</span></span> | <span data-ttu-id="6f96c-518">MixedReality. InspectorFields. asmdef。</span><span class="sxs-lookup"><span data-stu-id="6f96c-518">Microsoft.MixedReality.Toolkit.Demos.InspectorFields.Inspectors.asmdef</span></span> |
| <span data-ttu-id="6f96c-519">MixedRealityToolkit，例如 Interactables. asmdef</span><span class="sxs-lookup"><span data-stu-id="6f96c-519">MixedRealityToolkit.Examples.Demos.UX.Interactables.asmdef</span></span> | <span data-ttu-id="6f96c-520">MixedReality. Interactables. asmdef。</span><span class="sxs-lookup"><span data-stu-id="6f96c-520">Microsoft.MixedReality.Toolkit.Demos.UX.Interactables.asmdef</span></span> |
