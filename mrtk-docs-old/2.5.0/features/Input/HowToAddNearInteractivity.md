...
1. 確定已在主要 [MRTK 設定檔](../../out-of-scope/MixedRealityConfigurationGuide.md)中註冊相關的指標。
...
> ![NearInteractionTouchable Gizmos 範例](../Images/Input/Pointers/NearInteractionTouchableGizmos.png)
