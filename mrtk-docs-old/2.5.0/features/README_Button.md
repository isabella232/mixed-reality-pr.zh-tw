...
更新 FrontPlate 按鈕的大小 ![](Images/Button/MRTK_Button_SizeCustomization1.png)

更新四個按鈕的大小 ![](Images/Button/MRTK_Button_SizeCustomization2.png)

更新箱碰撞按鈕的大小 ![](Images/Button/MRTK_Button_SizeCustomization3.png)

按一下 [修正界限] ![ 按鈕](Images/Button/MRTK_Button_SizeCustomization4.png)
