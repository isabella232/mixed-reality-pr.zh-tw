...
* 查看 [停留燈](rendering/HoverLight.md)

### <a name="proximity-light"></a>近亮光

* 請參閱 [近亮燈](rendering/ProximityLight.md)
...
* 請參閱 [裁剪基本](Rendering/ClippingPrimitive.md)
...
* [互動](interactable.md)
* [停留燈](rendering/HoverLight.md)
* [近亮光](rendering/ProximityLight.md)
