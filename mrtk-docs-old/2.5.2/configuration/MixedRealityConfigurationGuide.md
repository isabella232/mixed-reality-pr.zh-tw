...
- [手勢設定](#gestures-configuration)
- [語音命令](#speech-commands)
- [控制器對應設定](#controller-visualization-settings)
- [控制器視覺效果設定](#controller-visualization-settings)
...
MRTK 會提供此選用服務，協助您管理複雜的加法場景載入/卸載。 若要判斷場景系統是否適合您的專案，請閱讀 [場景系統開始使用指南。](../features/scene-system/SceneSystemGettingStarted.md)
...
1. 啟動之後，在 MRTK 初始化之後，請交換設定檔以變更特定功能的行為方式。 例如，在應用程式中，可能會有想要完全移除的手指標的特定子體驗。 **請注意** ，這種類型的交換目前無法運作，因為這個 [問題](https://github.com/microsoft/MixedRealityToolkit-Unity/issues/4289)。
