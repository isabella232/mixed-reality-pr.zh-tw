...
4.  <span data-ttu-id="2ee76-155">在 [ **建立儲存體帳戶** ] 索引標籤中：</span><span class="sxs-lookup"><span data-stu-id="2ee76-155">In the **Create storage account** tab:</span></span>
    ...
    4.  <span data-ttu-id="2ee76-159">針對 [ **效能** ]，請選取 [ \**標準 *]。**</span><span class="sxs-lookup"><span data-stu-id="2ee76-159">For **Performance** , select **Standard\*.**</span></span>
...
3.  <span data-ttu-id="2ee76-182">當您按一下 [ **建立** 面板] 之後，就會出現您需要提供有關新媒體服務的一些詳細資料的位置：</span><span class="sxs-lookup"><span data-stu-id="2ee76-182">Once you have clicked on **Create** a panel will appear where you need to provide some details about your new Media Service:</span></span>
    ...
    6.  <span data-ttu-id="2ee76-193">您也必須確認您已瞭解套用到此服務的條款及條件。</span><span class="sxs-lookup"><span data-stu-id="2ee76-193">You will also need to confirm that you have understood the Terms and Conditions applied to this Service.</span></span>
...
<span data-ttu-id="2ee76-269">以下是使用混合式開發進行開發的一般設定，因此，它是適用于其他專案的絕佳範本。</span><span class="sxs-lookup"><span data-stu-id="2ee76-269">The following is a typical set up for developing with the Mixed Reality, and as such, is a good template for other projects.</span></span>
...
5.  <span data-ttu-id="2ee76-283">也請確定：</span><span class="sxs-lookup"><span data-stu-id="2ee76-283">Also make sure that:</span></span>
    ...
    6.  <span data-ttu-id="2ee76-289">請不要擔心立即設定 **幕後** 的工作，因為您稍後將會進行設定。</span><span class="sxs-lookup"><span data-stu-id="2ee76-289">Do not worry about setting up **Scenes** right now, as you will set these up later.</span></span>
...
## <a name="chapter-4---importing-the-insideoutsphere-unity-package"></a><span data-ttu-id="2ee76-306">第4章-匯入 InsideOutSphere Unity 套件</span><span class="sxs-lookup"><span data-stu-id="2ee76-306">Chapter 4 - Importing the InsideOutSphere Unity package</span></span>
...
14. <span data-ttu-id="2ee76-399">將 **InsideOutSphere** 物件從 [階層] **面板** 拖曳至 **球體** 位置，如下圖所示。</span><span class="sxs-lookup"><span data-stu-id="2ee76-399">Drag the **InsideOutSphere** object from the **Hierarchy Panel** to the **Sphere** slot, as shown in the image below.</span></span>
...
12. <span data-ttu-id="2ee76-455">**網格篩選器** 將會更新，現在是一個 **Cube** 。</span><span class="sxs-lookup"><span data-stu-id="2ee76-455">The **Mesh Filter** will update, and now be a **Cube** .</span></span> <span data-ttu-id="2ee76-456">現在，按一下 [ **球體碰撞** ] 旁的 **齒輪** 圖示，然後按一下 [ **移除元件** ]，即可從這個物件中刪除碰撞。</span><span class="sxs-lookup"><span data-stu-id="2ee76-456">Now, click the **Gear** icon next to **Sphere Collider** and click **Remove Component** , to delete the collider from this object.</span></span>

    ![第7章--設定兩個 Unity 場景](images/AzureLabs-Lab6-53.png)

13. <span data-ttu-id="2ee76-458">在仍選取 **GazeButton** 的情況下，按一下位於偵測 **器** 底部的 [ **新增元件** ] 按鈕。</span><span class="sxs-lookup"><span data-stu-id="2ee76-458">With the **GazeButton** still selected, click the **Add Component** button at the bottom of the **Inspector** .</span></span> <span data-ttu-id="2ee76-459">在 [搜尋] 欄位中 **，輸入方塊** ，方塊 **碰撞** 者將會是選項，請按一下此選項，將方塊 **碰撞** 程式新增至您的 **GazeButton** 物件。</span><span class="sxs-lookup"><span data-stu-id="2ee76-459">In the search field, type **box** , and **Box Collider** will be an option -- click that, to add a **Box Collider** to your **GazeButton** object.</span></span>

    ![第7章--設定兩個 Unity 場景](images/AzureLabs-Lab6-54.png)

14. <span data-ttu-id="2ee76-461">**GazeButton** 現在已部分更新，看起來會不同，不過，您現在會建立新的 **材質** ，讓它看起來完全不同，而且比第一個場景中的物件更容易辨識為不同的物件。</span><span class="sxs-lookup"><span data-stu-id="2ee76-461">The **GazeButton** is now partially updated, to look different, however, you will now create a new **Material** , so that it looks completely different, and is easier to recognize as a different object, than the object in the first scene.</span></span>

15. <span data-ttu-id="2ee76-462">流覽至 [ **專案] 面板** 中的 [ **材質** ] 資料夾。</span><span class="sxs-lookup"><span data-stu-id="2ee76-462">Navigate to your **Materials** folder, within the **Project Panel** .</span></span> <span data-ttu-id="2ee76-463">複製 **ButtonMaterial** 材質 (按下鍵盤上的 **Ctrl**  +  **D** ，或以滑鼠左鍵按一下 **材質** ，然後從 [ **編輯** 檔案] 功能表選項中，選取 [ **複製** ) 。</span><span class="sxs-lookup"><span data-stu-id="2ee76-463">Duplicate the **ButtonMaterial** Material (press **Ctrl** + **D** on the keyboard, or left-click the **Material** , then from the **Edit** file menu option, select **Duplicate** ).</span></span>

    <span data-ttu-id="2ee76-464">![第7章--設定兩個 Unity 場景 ](images/AzureLabs-Lab6-55.png)
     ![ 第7章--設定兩個 unity 場景](images/AzureLabs-Lab6-56.png)</span><span class="sxs-lookup"><span data-stu-id="2ee76-464">![Chapter 7 -- Setup the two Unity Scenes](images/AzureLabs-Lab6-55.png)
![Chapter 7 -- Setup the two Unity Scenes](images/AzureLabs-Lab6-56.png)</span></span>

16. <span data-ttu-id="2ee76-465">選取名為 **ButtonMaterial 1** ) 的新 **ButtonMaterial** 材質 (，然後在 [偵測 **器** ] 中，按一下 [ **>albedo** 色彩] 視窗。</span><span class="sxs-lookup"><span data-stu-id="2ee76-465">Select the new **ButtonMaterial** Material (here named **ButtonMaterial 1** ), and within the **Inspector** , click the **Albedo** color window.</span></span> <span data-ttu-id="2ee76-466">快顯視窗隨即出現，您可以在其中選取另一種色彩 (選擇任何您喜歡的) ，然後關閉快顯視窗。</span><span class="sxs-lookup"><span data-stu-id="2ee76-466">A popup will appear, where you can select another color (choose whichever you like), then close the popup.</span></span> <span data-ttu-id="2ee76-467">材質將會是自己的實例，而且不同于原始的實例。</span><span class="sxs-lookup"><span data-stu-id="2ee76-467">The Material will be its own instance, and different to the original.</span></span>

    ![第7章--設定兩個 Unity 場景](images/AzureLabs-Lab6-57.png)

17. <span data-ttu-id="2ee76-469">將新的 **材質** 拖曳至 **GazeButton** 子系上，以完整更新其外觀，以便從第一個場景按鈕輕鬆地辨別。</span><span class="sxs-lookup"><span data-stu-id="2ee76-469">Drag the new **Material** onto the **GazeButton** child, to now completely update its look, so that it is easily distinguishable from the first scenes button.</span></span>

    ![第7章--設定兩個 Unity 場景](images/AzureLabs-Lab6-58.png)

18. <span data-ttu-id="2ee76-471">至此，您可以在建立 UWP 專案之前，先在編輯器中測試專案。</span><span class="sxs-lookup"><span data-stu-id="2ee76-471">At this point you can test the project in the Editor before building the UWP project.</span></span>

    -  <span data-ttu-id="2ee76-472">在 **編輯器** 中按下 [ **播放** ] 按鈕，並磨損您的耳機。</span><span class="sxs-lookup"><span data-stu-id="2ee76-472">Press the **Play** button in the **Editor** and wear your headset.</span></span>

        ![第7章--設定兩個 Unity 場景](images/AzureLabs-Lab6-59.png)

19. <span data-ttu-id="2ee76-474">查看兩個 **GazeButton** 物件，以在第一和第二部影片之間切換。</span><span class="sxs-lookup"><span data-stu-id="2ee76-474">Look at the two **GazeButton** objects to switch between the first and second video.</span></span>

## <a name="chapter-8---build-the-uwp-solution"></a><span data-ttu-id="2ee76-475">第8章-建立 UWP 解決方案</span><span class="sxs-lookup"><span data-stu-id="2ee76-475">Chapter 8 - Build the UWP Solution</span></span>

<span data-ttu-id="2ee76-476">確定編輯器沒有任何錯誤之後，您就可以開始建立。</span><span class="sxs-lookup"><span data-stu-id="2ee76-476">Once you have ensured that the editor has no errors, you are ready to Build.</span></span>

<span data-ttu-id="2ee76-477">若要建立：</span><span class="sxs-lookup"><span data-stu-id="2ee76-477">To Build:</span></span>

1.  <span data-ttu-id="2ee76-478">按一下 [檔案] **> 儲存** ]，以儲存目前的場景。</span><span class="sxs-lookup"><span data-stu-id="2ee76-478">Save the current scene by clicking on **File > Save** .</span></span>

2.  <span data-ttu-id="2ee76-479">核取稱為 **Unity C \# Projects** 的方塊 (這很重要，因為它可讓您在組建完成) 之後編輯類別。</span><span class="sxs-lookup"><span data-stu-id="2ee76-479">Check the box called **Unity C\# Projects** (this is important because it will allow you to edit the classes after build is completed).</span></span>

3.  <span data-ttu-id="2ee76-480">移至 [檔案 **> 組建設定** ] 中，按一下 [ **組建** ]。</span><span class="sxs-lookup"><span data-stu-id="2ee76-480">Go to **File > Build Settings** , click on **Build** .</span></span>

4.  <span data-ttu-id="2ee76-481">系統會提示您選取要在其中建立解決方案的資料夾。</span><span class="sxs-lookup"><span data-stu-id="2ee76-481">You will be prompted to select the folder where you want to build the Solution.</span></span>

5.  <span data-ttu-id="2ee76-482">建立 **組建** 資料夾，然後在該資料夾內使用您選擇的適當名稱建立另一個資料夾。</span><span class="sxs-lookup"><span data-stu-id="2ee76-482">Create a **BUILDS** folder and within that folder create another folder with an appropriate name of your choice.</span></span>

6.  <span data-ttu-id="2ee76-483">按一下新資料夾，然後按一下 [ **選取資料夾** ]，選擇該資料夾，在該位置開始組建。</span><span class="sxs-lookup"><span data-stu-id="2ee76-483">Click your new folder and then click **Select Folder** , so to choose that folder, to begin the build at that location.</span></span>

    <span data-ttu-id="2ee76-484">![第8章--建立 UWP 解決方案 ](images/AzureLabs-Lab6-60.png)
     ![ 第8章--建立 uwp 解決方案](images/AzureLabs-Lab6-61.png)</span><span class="sxs-lookup"><span data-stu-id="2ee76-484">![Chapter 8 -- Build the UWP Solution](images/AzureLabs-Lab6-60.png)
![Chapter 8 -- Build the UWP Solution](images/AzureLabs-Lab6-61.png)</span></span>

7.  <span data-ttu-id="2ee76-485">Unity 完成組建之後 (可能需要一些時間) ，它會在您的組建位置開啟 **檔案總管** 視窗。</span><span class="sxs-lookup"><span data-stu-id="2ee76-485">Once Unity has finished building (it might take some time), it will open a **File Explorer** window at the location of your build.</span></span>

## <a name="chapter-9---deploy-on-local-machine"></a><span data-ttu-id="2ee76-486">第9章-在本機電腦上部署</span><span class="sxs-lookup"><span data-stu-id="2ee76-486">Chapter 9 - Deploy on Local Machine</span></span>

<span data-ttu-id="2ee76-487">組建完成後， **檔案總管** 視窗會出現在組建的位置。</span><span class="sxs-lookup"><span data-stu-id="2ee76-487">Once the build has been completed, a **File Explorer** window will appear at the location of your build.</span></span> <span data-ttu-id="2ee76-488">開啟您命名和建立的資料夾，然後按兩下該資料夾內的方案 ( .sln) 檔案，以 Visual Studio 2017 開啟您的解決方案。</span><span class="sxs-lookup"><span data-stu-id="2ee76-488">Open the Folder you named and built to, then double click on the solution (.sln) file within that folder, to open your solution with Visual Studio 2017.</span></span>

<span data-ttu-id="2ee76-489">唯一要做的事，就是將您的應用程式部署到電腦 (或 *本機電腦* ) 。</span><span class="sxs-lookup"><span data-stu-id="2ee76-489">The only thing left to do is deploy your app to your computer (or *Local Machine* ).</span></span>

<span data-ttu-id="2ee76-490">若要部署到本機電腦：</span><span class="sxs-lookup"><span data-stu-id="2ee76-490">To deploy to Local Machine:</span></span>

1.  <span data-ttu-id="2ee76-491">在 **Visual Studio 2017** 中，開啟剛建立的方案檔。</span><span class="sxs-lookup"><span data-stu-id="2ee76-491">In **Visual Studio 2017** , open the solution file that has just been created.</span></span>

2.  <span data-ttu-id="2ee76-492">在 [ **方案平臺** ] 中，選取 [ **x86]、[本機電腦** ]。</span><span class="sxs-lookup"><span data-stu-id="2ee76-492">In the **Solution Platform** , select **x86, Local Machine** .</span></span>

3.  <span data-ttu-id="2ee76-493">在 [ **方案** 設定] 中選取 [ **Debug** ]。</span><span class="sxs-lookup"><span data-stu-id="2ee76-493">In the **Solution Configuration** select **Debug** .</span></span>

    ![第9章--在本機電腦上部署](images/AzureLabs-Lab6-62.png)

4.  <span data-ttu-id="2ee76-495">您現在需要將任何套件還原至您的解決方案。</span><span class="sxs-lookup"><span data-stu-id="2ee76-495">You will now need to restore any packages to your solution.</span></span> <span data-ttu-id="2ee76-496">以滑鼠右鍵按一下您的 **方案** ，然後按一下 [ **還原解決方案的 NuGet 套件** ]。</span><span class="sxs-lookup"><span data-stu-id="2ee76-496">Right-click on your **Solution** , and click **Restore NuGet Packages for Solution...**</span></span>

    > [!NOTE] 
    > <span data-ttu-id="2ee76-497">這是因為 Unity 所建立的套件必須以您的本機電腦參考為目標。</span><span class="sxs-lookup"><span data-stu-id="2ee76-497">This is done because the packages which Unity built need to be targeted to work with your local machines references.</span></span>

5.  <span data-ttu-id="2ee76-498">移至 [ **組建] 功能表** ，然後按一下 [ **部署方案** ]，將應用程式側載至您的電腦。</span><span class="sxs-lookup"><span data-stu-id="2ee76-498">Go to **Build menu** and click on **Deploy Solution** to sideload the application to your machine.</span></span> <span data-ttu-id="2ee76-499">Visual Studio 將會先建立您的應用程式，然後再加以部署。</span><span class="sxs-lookup"><span data-stu-id="2ee76-499">Visual Studio will first build and then deploy your application.</span></span>

6.  <span data-ttu-id="2ee76-500">您的應用程式現在應該會出現在已安裝的應用程式清單中，準備好要啟動。</span><span class="sxs-lookup"><span data-stu-id="2ee76-500">Your App should now appear in the list of installed apps, ready to be launched.</span></span>

    ![第9章--在本機電腦上部署](images/AzureLabs-Lab6-63.png)

<span data-ttu-id="2ee76-502">當您執行混合現實應用程式時，您會在應用程式中使用的 **InsideOutSphere** 模型內。</span><span class="sxs-lookup"><span data-stu-id="2ee76-502">When you run the Mixed Reality application, you will you be within the **InsideOutSphere** model which you used within your app.</span></span> <span data-ttu-id="2ee76-503">此球體將是影片串流處理的位置，可提供 filmed 的內送影片的360度觀點， (這種) 的觀點。</span><span class="sxs-lookup"><span data-stu-id="2ee76-503">This sphere will be where the video will be streamed to, providing a 360-degree view, of the incoming video (which was filmed for this kind of perspective).</span></span> <span data-ttu-id="2ee76-504">如果影片需要幾秒鐘的時間才能載入，您的應用程式會受到您的可用網際網路速度的要求，因為影片需要先取出再下載，以串流至您的應用程式。</span><span class="sxs-lookup"><span data-stu-id="2ee76-504">Do not be surprised if the video takes a couple of seconds to load, your app is subject to your available Internet speed, as the video needs to be fetched and then downloaded, so to stream into your app.</span></span>
<span data-ttu-id="2ee76-505">當您準備好時，請以紅色球體撥雲見日來變更場景，並開啟第二個影片！</span><span class="sxs-lookup"><span data-stu-id="2ee76-505">When you are ready, change scenes and open your second video, by gazing at the red sphere!</span></span> <span data-ttu-id="2ee76-506">然後，您可以在第二個場景中使用藍色立方體來自由返回！</span><span class="sxs-lookup"><span data-stu-id="2ee76-506">Then feel free to go back, using the blue cube in the second scene!</span></span>

## <a name="your-finished-azure-media-service-application"></a><span data-ttu-id="2ee76-507">您已完成的 Azure 媒體服務應用程式</span><span class="sxs-lookup"><span data-stu-id="2ee76-507">Your finished Azure Media Service application</span></span>
 
<span data-ttu-id="2ee76-508">恭喜，您建立了一個混合現實應用程式，利用 Azure 媒體服務來串流360的影片。</span><span class="sxs-lookup"><span data-stu-id="2ee76-508">Congratulations, you built a mixed reality app that leverages the Azure Media Service to stream 360 videos.</span></span>

![實驗室結果](images/AzureLabs-Lab6-00.png)

![實驗室結果](images/AzureLabs-Lab6-01.png)

## <a name="bonus-exercises"></a><span data-ttu-id="2ee76-511">額外練習</span><span class="sxs-lookup"><span data-stu-id="2ee76-511">Bonus Exercises</span></span>

<span data-ttu-id="2ee76-512">**練習1**</span><span class="sxs-lookup"><span data-stu-id="2ee76-512">**Exercise 1**</span></span>

<span data-ttu-id="2ee76-513">您可以在本教學課程中，只使用單一場景來變更影片。</span><span class="sxs-lookup"><span data-stu-id="2ee76-513">It is entirely possible to only use a single scene to change videos within this tutorial.</span></span> <span data-ttu-id="2ee76-514">試驗您的應用程式，並使其進入單一場景！</span><span class="sxs-lookup"><span data-stu-id="2ee76-514">Experiment with your application and make it into a single scene!</span></span> <span data-ttu-id="2ee76-515">或許甚至可以將另一部影片新增至混合。</span><span class="sxs-lookup"><span data-stu-id="2ee76-515">Perhaps even add another video to the mix.</span></span>

<span data-ttu-id="2ee76-516">**練習2**</span><span class="sxs-lookup"><span data-stu-id="2ee76-516">**Exercise 2**</span></span>

<span data-ttu-id="2ee76-517">使用 Azure 和 Unity 進行實驗，並嘗試執行應用程式自動選取不同檔案大小的影片，視網際網路連線的強度而定。</span><span class="sxs-lookup"><span data-stu-id="2ee76-517">Experiment with Azure and Unity, and attempt to implement the ability for the app to automatically select a video with a different file size, depending on the strength of an Internet connection.</span></span>
