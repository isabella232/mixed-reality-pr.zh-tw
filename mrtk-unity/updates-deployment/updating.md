...
1. <span data-ttu-id="a6a30-131">如果您在升級步驟中的任何時間點遇到任何阻礙，請儲存目前專案的複本。</span><span class="sxs-lookup"><span data-stu-id="a6a30-131">Save a copy of your current project, in case you hit any snags at any point in the upgrade steps.</span></span>
...
### <a name="folder-renames-in-240"></a><span data-ttu-id="a6a30-172">2.4.0 中的資料夾重新命名</span><span class="sxs-lookup"><span data-stu-id="a6a30-172">Folder renames in 2.4.0</span></span>
...
<span data-ttu-id="a6a30-252">雖然現有的程式碼在版本2.3.0 中仍可繼續運作，但建議您更新至新的類別。</span><span class="sxs-lookup"><span data-stu-id="a6a30-252">While existing code will continue to function in version 2.3.0, it is recommended to update to the new class.</span></span>
...
<span data-ttu-id="a6a30-273">應用程式程式碼可能會因為這種變更而需要更新。</span><span class="sxs-lookup"><span data-stu-id="a6a30-273">Application code may require updating due to this change.</span></span>
...
- [<span data-ttu-id="a6a30-289">API 變更</span><span class="sxs-lookup"><span data-stu-id="a6a30-289">API changes</span></span>](#api-changes-in-210)
...
<span data-ttu-id="a6a30-307">**互動**</span><span class="sxs-lookup"><span data-stu-id="a6a30-307">**Interactable**</span></span>
...
<span data-ttu-id="a6a30-354">**MixedRealityToolkit**</span><span class="sxs-lookup"><span data-stu-id="a6a30-354">**MixedRealityToolkit**</span></span>
...
<span data-ttu-id="a6a30-383">新 `RegisterHandler` 的 API 和 `UnregisterHandler` ：</span><span class="sxs-lookup"><span data-stu-id="a6a30-383">New API `RegisterHandler` and `UnregisterHandler`:</span></span>
...
<span data-ttu-id="a6a30-414">**_SurfaceMagnetism_**</span><span class="sxs-lookup"><span data-stu-id="a6a30-414">**_SurfaceMagnetism_**</span></span>
...
- <span data-ttu-id="a6a30-429">NearInteractionTouchable 不會處理 Unity UI 畫布的任何時間。</span><span class="sxs-lookup"><span data-stu-id="a6a30-429">NearInteractionTouchable does not handle Unity UI canvas touching any longer.</span></span> <span data-ttu-id="a6a30-430">NearInteractionTouchableUnityUI 類別必須立即用於 Unity UI touchables。</span><span class="sxs-lookup"><span data-stu-id="a6a30-430">The NearInteractionTouchableUnityUI class must be used for Unity UI touchables now.</span></span>
- <span data-ttu-id="a6a30-431">ColliderNearInteractionTouchable 是以 colliders 為基礎之 touchables 的新基類，也就是 NearInteractionTouchableUnityUI 以外的每個可觸式。</span><span class="sxs-lookup"><span data-stu-id="a6a30-431">ColliderNearInteractionTouchable is the new base class for touchables based on colliders, i.e. every touchable except NearInteractionTouchableUnityUI.</span></span>
- <span data-ttu-id="a6a30-432">BaseNearInteractionTouchable. DistFront 已移動並重新命名為 PokePointer。 TouchableDistance 這是 PokePointer 可以與 touchables 互動的距離。</span><span class="sxs-lookup"><span data-stu-id="a6a30-432">BaseNearInteractionTouchable.DistFront has been moved and renamed to PokePointer.TouchableDistance This is the distance and which the PokePointer can interact with touchables.</span></span> <span data-ttu-id="a6a30-433">先前每個可觸式都有自己的最大互動距離，但現在會在 PokePointer 中定義，以提供更佳的優化。</span><span class="sxs-lookup"><span data-stu-id="a6a30-433">Previously each touchable had its own maximum interaction distance, but now this is defined in the PokePointer which allows better optimization.</span></span>
- <span data-ttu-id="a6a30-434">BaseNearInteractionTouchable 已重新命名為 PokeThreshold，因此它會清楚指出 PokeThreshold 是 DebounceThreshold 的對應項。</span><span class="sxs-lookup"><span data-stu-id="a6a30-434">BaseNearInteractionTouchable.DistBack has been renamed to PokeThreshold This makes it clear that PokeThreshold is the counterpart to DebounceThreshold.</span></span> <span data-ttu-id="a6a30-435">當超過 PokeThreshold 時，即會啟動可觸式，並在超過 DebounceThreshold 時釋放。</span><span class="sxs-lookup"><span data-stu-id="a6a30-435">A touchable is activated when the PokeThreshold is crossed, and released when DebounceThreshold is crossed.</span></span>

<span data-ttu-id="a6a30-436">**ReadOnlyAttribute**</span><span class="sxs-lookup"><span data-stu-id="a6a30-436">**ReadOnlyAttribute**</span></span>

<span data-ttu-id="a6a30-437">已將 `Microsoft.MixedReality.Toolkit` 命名空間加入至 `ReadOnlyAttribute` 、 `BeginReadOnlyGroupAttribute` 和 `EndReadOnlyGroupAttribute` 。</span><span class="sxs-lookup"><span data-stu-id="a6a30-437">The `Microsoft.MixedReality.Toolkit` namespace has been added to `ReadOnlyAttribute`, `BeginReadOnlyGroupAttribute`, and `EndReadOnlyGroupAttribute`.</span></span>

<span data-ttu-id="a6a30-438">**PointerClickHandler**</span><span class="sxs-lookup"><span data-stu-id="a6a30-438">**PointerClickHandler**</span></span>

<span data-ttu-id="a6a30-439">`PointerClickHandler` 類別已被取代。</span><span class="sxs-lookup"><span data-stu-id="a6a30-439">The `PointerClickHandler` class has been deprecated.</span></span> <span data-ttu-id="a6a30-440">您 `PointerHandler` 應該改為使用，它會提供相同的功能。</span><span class="sxs-lookup"><span data-stu-id="a6a30-440">The `PointerHandler` should be used instead, it provides the same functionality.</span></span>

<span data-ttu-id="a6a30-441">**HoloLens clicker 支援**</span><span class="sxs-lookup"><span data-stu-id="a6a30-441">**HoloLens clicker support**</span></span>

<span data-ttu-id="a6a30-442">HoloLens clicker 的控制器對應已從狀況變更 [`WindowsMixedRealityController`](xref:Microsoft.MixedReality.Toolkit.WindowsMixedReality.Input.WindowsMixedRealityController) 為狀況 [`WindowsMixedRealityGGVHand`](xref:Microsoft.MixedReality.Toolkit.WindowsMixedReality.Input.WindowsMixedRealityGGVHand) 。</span><span class="sxs-lookup"><span data-stu-id="a6a30-442">The HoloLens clicker's controller mappings have changed from being an unhanded [`WindowsMixedRealityController`](xref:Microsoft.MixedReality.Toolkit.WindowsMixedReality.Input.WindowsMixedRealityController) to being an unhanded [`WindowsMixedRealityGGVHand`](xref:Microsoft.MixedReality.Toolkit.WindowsMixedReality.Input.WindowsMixedRealityGGVHand).</span></span> <span data-ttu-id="a6a30-443">為了因應此情況，當您第一次開啟 ControllerMapping 設定檔時，會執行自動更新程式。</span><span class="sxs-lookup"><span data-stu-id="a6a30-443">To account for this, an automatic updater will run the first time you open your ControllerMapping profile.</span></span> <span data-ttu-id="a6a30-444">請至少在升級至2.0.0 之後開啟任何自訂設定檔一次，以觸發這個一次性的遷移步驟。</span><span class="sxs-lookup"><span data-stu-id="a6a30-444">Please open any custom profiles at least once after upgrading to 2.0.0 in order to trigger this one-time migration step.</span></span>

<span data-ttu-id="a6a30-445">**InteractableHighlight**</span><span class="sxs-lookup"><span data-stu-id="a6a30-445">**InteractableHighlight**</span></span>

<span data-ttu-id="a6a30-446">`InteractableHighlight` 類別已被取代。</span><span class="sxs-lookup"><span data-stu-id="a6a30-446">The `InteractableHighlight` class has been deprecated.</span></span> <span data-ttu-id="a6a30-447">`InteractableOnFocus` `FocusInteractableStates` 應改為使用類別和資產。</span><span class="sxs-lookup"><span data-stu-id="a6a30-447">The `InteractableOnFocus` class and `FocusInteractableStates` asset should be used instead.</span></span> <span data-ttu-id="a6a30-448">若要為建立新的 `Theme` 資產 `InteractableOnFocus` ，請在 [專案] 視窗中按一下滑鼠右鍵，然後選取 [*建立*  >  *混合現實工具* 組  >  *互動*  >  *主題*]。</span><span class="sxs-lookup"><span data-stu-id="a6a30-448">To create a new `Theme` asset for the `InteractableOnFocus`, right click in the project window and select *Create* > *Mixed Reality Toolkit* > *Interactable* > *Theme*.</span></span>

<span data-ttu-id="a6a30-449">**HandInteractionPanZoom**</span><span class="sxs-lookup"><span data-stu-id="a6a30-449">**HandInteractionPanZoom**</span></span>

<span data-ttu-id="a6a30-450">`HandInteractionPanZoom` 已移至 UI 命名空間，因為它不是輸入元件。</span><span class="sxs-lookup"><span data-stu-id="a6a30-450">`HandInteractionPanZoom` has been moved to the UI namespace as it was not an input component.</span></span> <span data-ttu-id="a6a30-451">`HandPanEventData` 也已移至此命名空間，並簡化為與其他 UI 事件資料對應。</span><span class="sxs-lookup"><span data-stu-id="a6a30-451">`HandPanEventData` has also been moved into this namespace, and simplified to correspond with other UI event data.</span></span>

### <a name="assembly-name-changes-in-200"></a><span data-ttu-id="a6a30-452">2.0.0 中的元件名稱變更</span><span class="sxs-lookup"><span data-stu-id="a6a30-452">Assembly name changes in 2.0.0</span></span>

<span data-ttu-id="a6a30-453">在2.0.0 版本中，所有的官方混合現實工具組元件名稱及其相關聯的元件定義 (. asmdef) 檔案都已更新為符合下列模式。</span><span class="sxs-lookup"><span data-stu-id="a6a30-453">In The 2.0.0 release, all of the official Mixed Reality Toolkit assembly names and their associated assembly definition (.asmdef) files have been updated to fit the following pattern.</span></span>

```c#
Microsoft.MixedReality.Toolkit[.<name>]
```

<span data-ttu-id="a6a30-454">在某些情況下，已合併多個元件以建立更好的 unity 內容。</span><span class="sxs-lookup"><span data-stu-id="a6a30-454">In some instances, multiple assemblies have been merged to create better unity of their contents.</span></span> <span data-ttu-id="a6a30-455">如果您的專案使用自訂的 asmdef 檔案，則可能需要更新。</span><span class="sxs-lookup"><span data-stu-id="a6a30-455">If your project uses custom .asmdef files, they may require updating.</span></span>

<span data-ttu-id="a6a30-456">下表說明 RC2 asmdef 檔案名如何對應至2.0.0 版本。</span><span class="sxs-lookup"><span data-stu-id="a6a30-456">The following tables describe how the RC2 .asmdef file names map to the 2.0.0 release.</span></span> <span data-ttu-id="a6a30-457">所有元件名稱都符合 asmdef 檔案名。</span><span class="sxs-lookup"><span data-stu-id="a6a30-457">All assembly names match the .asmdef file name.</span></span>

<span data-ttu-id="a6a30-458">**MixedRealityToolkit**</span><span class="sxs-lookup"><span data-stu-id="a6a30-458">**MixedRealityToolkit**</span></span>

| <span data-ttu-id="a6a30-459">RC2</span><span class="sxs-lookup"><span data-stu-id="a6a30-459">RC2</span></span> | <span data-ttu-id="a6a30-460">2.0.0</span><span class="sxs-lookup"><span data-stu-id="a6a30-460">2.0.0</span></span> |
| --- | --- |
| <span data-ttu-id="a6a30-461">MixedRealityToolkit.asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-461">MixedRealityToolkit.asmdef</span></span> | <span data-ttu-id="a6a30-462">MixedReality 工具組. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-462">Microsoft.MixedReality.Toolkit.asmdef</span></span> |
| <span data-ttu-id="a6a30-463">MixedRealityToolkit. BuildAndDeploy. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-463">MixedRealityToolkit.Core.BuildAndDeploy.asmdef</span></span> | <span data-ttu-id="a6a30-464">MixedReality. BuildAndDeploy. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-464">Microsoft.MixedReality.Toolkit.Editor.BuildAndDeploy.asmdef</span></span> |
| <span data-ttu-id="a6a30-465">MixedRealityToolkit，asmdef 的</span><span class="sxs-lookup"><span data-stu-id="a6a30-465">MixedRealityToolkit.Core.Definitions.Utilities.Editor.asmdef</span></span> | <span data-ttu-id="a6a30-466">已移除，請使用 MixedReality 工具組。 asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-466">Removed, use Microsoft.MixedReality.Toolkit.Editor.Utilities.asmdef</span></span> |
| <span data-ttu-id="a6a30-467">MixedRealityToolkit. EditorClassExtensions. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-467">MixedRealityToolkit.Core.Extensions.EditorClassExtensions.asmdef</span></span> | <span data-ttu-id="a6a30-468">MixedReality. ClassExtensions. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-468">Microsoft.MixedReality.Toolkit.Editor.ClassExtensions.asmdef</span></span>
| <span data-ttu-id="a6a30-469">MixedRealityToolkit asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-469">MixedRealityToolkit.Core.Inspectors.asmdef</span></span> | <span data-ttu-id="a6a30-470">MixedReality. asmdef。</span><span class="sxs-lookup"><span data-stu-id="a6a30-470">Microsoft.MixedReality.Toolkit.Editor.Inspectors.asmdef</span></span> |
| <span data-ttu-id="a6a30-471">MixedRealityToolkit ServiceInspectors. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-471">MixedRealityToolkit.Core.Inspectors.ServiceInspectors.asmdef</span></span> | <span data-ttu-id="a6a30-472">MixedReality. ServiceInspectors. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-472">Microsoft.MixedReality.Toolkit.Editor.ServiceInspectors.asmdef</span></span> |
| <span data-ttu-id="a6a30-473">MixedRealityToolkit. UtilitiesAsync. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-473">MixedRealityToolkit.Core.UtilitiesAsync.asmdef</span></span> | <span data-ttu-id="a6a30-474">MixedReality. asmdef。</span><span class="sxs-lookup"><span data-stu-id="a6a30-474">Microsoft.MixedReality.Toolkit.Async.asmdef</span></span> |
| <span data-ttu-id="a6a30-475">Asmdef 的 MixedRealityToolkit。</span><span class="sxs-lookup"><span data-stu-id="a6a30-475">MixedRealityToolkit.Core.Utilities.Editor.asmdef</span></span> | <span data-ttu-id="a6a30-476">MixedReality 工具組。 asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-476">Microsoft.MixedReality.Toolkit.Editor.Utilities.asmdef</span></span> |
| <span data-ttu-id="a6a30-477">MixedRealityToolkit Gltf. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-477">MixedRealityToolkit.Utilities.Gltf.asmdef</span></span> | <span data-ttu-id="a6a30-478">MixedReality. Gltf. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-478">Microsoft.MixedReality.Toolkit.Gltf.asmdef</span></span> |
| <span data-ttu-id="a6a30-479">MixedRealityToolkit，Gltf asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-479">MixedRealityToolkit.Utilities.Gltf.Importers.asmdef</span></span> | <span data-ttu-id="a6a30-480">MixedReality. Gltf. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-480">Microsoft.MixedReality.Toolkit.Gltf.Importers.asmdef</span></span> |

<span data-ttu-id="a6a30-481">**MixedRealityToolkit。提供者**</span><span class="sxs-lookup"><span data-stu-id="a6a30-481">**MixedRealityToolkit.Providers**</span></span>

| <span data-ttu-id="a6a30-482">RC2</span><span class="sxs-lookup"><span data-stu-id="a6a30-482">RC2</span></span> | <span data-ttu-id="a6a30-483">2.0.0</span><span class="sxs-lookup"><span data-stu-id="a6a30-483">2.0.0</span></span> |
| --- | --- |
| <span data-ttu-id="a6a30-484">MixedRealityToolkit. OpenVR. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-484">MixedRealityToolkit.Providers.OpenVR.asmdef</span></span> | <span data-ttu-id="a6a30-485">MixedReality. OpenVR. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-485">Microsoft.MixedReality.Toolkit.Providers.OpenVR.asmdef</span></span> |
| <span data-ttu-id="a6a30-486">MixedRealityToolkit. WindowsMixedReality. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-486">MixedRealityToolkit.Providers.WindowsMixedReality.asmdef</span></span> | <span data-ttu-id="a6a30-487">MixedReality. WindowsMixedReality. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-487">Microsoft.MixedReality.Toolkit.Providers.WindowsMixedReality.asmdef</span></span> |
| <span data-ttu-id="a6a30-488">MixedRealityToolkit. WindowsVoiceInput. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-488">MixedRealityToolkit.Providers.WindowsVoiceInput.asmdef</span></span> | <span data-ttu-id="a6a30-489">MixedReality. WindowsVoiceInput. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-489">Microsoft.MixedReality.Toolkit.Providers.WindowsVoiceInput.asmdef</span></span> |

<span data-ttu-id="a6a30-490">**MixedRealityToolkit 服務**</span><span class="sxs-lookup"><span data-stu-id="a6a30-490">**MixedRealityToolkit.Services**</span></span>

| <span data-ttu-id="a6a30-491">RC2</span><span class="sxs-lookup"><span data-stu-id="a6a30-491">RC2</span></span> | <span data-ttu-id="a6a30-492">2.0.0</span><span class="sxs-lookup"><span data-stu-id="a6a30-492">2.0.0</span></span> |
| --- | --- |
| <span data-ttu-id="a6a30-493">MixedRealityToolkit. BoundarySystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-493">MixedRealityToolkit.Services.BoundarySystem.asmdef</span></span> | <span data-ttu-id="a6a30-494">MixedReality. BoundarySystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-494">Microsoft.MixedReality.Toolkit.Services.BoundarySystem.asmdef</span></span> |
| <span data-ttu-id="a6a30-495">MixedRealityToolkit. CameraSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-495">MixedRealityToolkit.Services.CameraSystem.asmdef</span></span> | <span data-ttu-id="a6a30-496">MixedReality. CameraSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-496">Microsoft.MixedReality.Toolkit.Services.CameraSystem.asmdef</span></span> |
| <span data-ttu-id="a6a30-497">MixedRealityToolkit. DiagnosticsSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-497">MixedRealityToolkit.Services.DiagnosticsSystem.asmdef</span></span> | <span data-ttu-id="a6a30-498">MixedReality. DiagnosticsSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-498">Microsoft.MixedReality.Toolkit.Services.DiagnosticsSystem.asmdef</span></span> |
| <span data-ttu-id="a6a30-499">MixedRealityToolkit. InputSimulation. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-499">MixedRealityToolkit.Services.InputSimulation.asmdef</span></span> | <span data-ttu-id="a6a30-500">MixedReality. InputSimulation. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-500">Microsoft.MixedReality.Toolkit.Services.InputSimulation.asmdef</span></span> |
| <span data-ttu-id="a6a30-501">MixedRealityToolkit. InputSimulation. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-501">MixedRealityToolkit.Services.InputSimulation.Editor.asmdef</span></span> | <span data-ttu-id="a6a30-502">MixedReality. InputSimulation. asmdef。</span><span class="sxs-lookup"><span data-stu-id="a6a30-502">Microsoft.MixedReality.Toolkit.Services.InputSimulation.Editor.asmdef</span></span> |
| <span data-ttu-id="a6a30-503">MixedRealityToolkit. InputSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-503">MixedRealityToolkit.Services.InputSystem.asmdef</span></span> | <span data-ttu-id="a6a30-504">MixedReality. InputSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-504">Microsoft.MixedReality.Toolkit.Services.InputSystem.asmdef</span></span> |
| <span data-ttu-id="a6a30-505">MixedRealityToolkit asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-505">MixedRealityToolkit.Services.Inspectors.asmdef</span></span> | <span data-ttu-id="a6a30-506">MixedReality. InputSystem. asmdef。</span><span class="sxs-lookup"><span data-stu-id="a6a30-506">Microsoft.MixedReality.Toolkit.Services.InputSystem.Editor.asmdef</span></span> |
| <span data-ttu-id="a6a30-507">MixedRealityToolkit. SceneSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-507">MixedRealityToolkit.Services.SceneSystem.asmdef</span></span> | <span data-ttu-id="a6a30-508">MixedReality. SceneSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-508">Microsoft.MixedReality.Toolkit.Services.SceneSystem.asmdef</span></span> |
| <span data-ttu-id="a6a30-509">MixedRealityToolkit. SpatialAwarenessSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-509">MixedRealityToolkit.Services.SpatialAwarenessSystem.asmdef</span></span> | <span data-ttu-id="a6a30-510">MixedReality. SpatialAwarenessSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-510">Microsoft.MixedReality.Toolkit.Services.SpatialAwarenessSystem.asmdef</span></span> |
| <span data-ttu-id="a6a30-511">MixedRealityToolkit. TeleportSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-511">MixedRealityToolkit.Services.TeleportSystem.asmdef</span></span> | <span data-ttu-id="a6a30-512">MixedReality. TeleportSystem. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-512">Microsoft.MixedReality.Toolkit.Services.TeleportSystem.asmdef</span></span> |

<span data-ttu-id="a6a30-513">**MixedRealityToolkit SDK**</span><span class="sxs-lookup"><span data-stu-id="a6a30-513">**MixedRealityToolkit.SDK**</span></span>

| <span data-ttu-id="a6a30-514">RC2</span><span class="sxs-lookup"><span data-stu-id="a6a30-514">RC2</span></span> | <span data-ttu-id="a6a30-515">2.0.0</span><span class="sxs-lookup"><span data-stu-id="a6a30-515">2.0.0</span></span> |
| --- | --- |
| <span data-ttu-id="a6a30-516">MixedRealityToolkit. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-516">MixedRealityToolkit.SDK.asmdef</span></span> | <span data-ttu-id="a6a30-517">MixedReality 工具組. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-517">Microsoft.MixedReality.Toolkit.SDK.asmdef</span></span> |
| <span data-ttu-id="a6a30-518">MixedRealityToolkit asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-518">MixedRealityToolkit.SDK.Inspectors.asmdef</span></span> | <span data-ttu-id="a6a30-519">MixedReality 工具組. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-519">Microsoft.MixedReality.Toolkit.SDK.Inspectors.asmdef</span></span> |

<span data-ttu-id="a6a30-520">**MixedRealityToolkit 範例**</span><span class="sxs-lookup"><span data-stu-id="a6a30-520">**MixedRealityToolkit.Examples**</span></span>

| <span data-ttu-id="a6a30-521">RC2</span><span class="sxs-lookup"><span data-stu-id="a6a30-521">RC2</span></span> | <span data-ttu-id="a6a30-522">2.0.0</span><span class="sxs-lookup"><span data-stu-id="a6a30-522">2.0.0</span></span> |
| --- | --- |
| <span data-ttu-id="a6a30-523">MixedRealityToolkit。例如 asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-523">MixedRealityToolkit.Examples.asmdef</span></span> | <span data-ttu-id="a6a30-524">MixedReality，例如 asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-524">Microsoft.MixedReality.Toolkit.Examples.asmdef</span></span> |
| <span data-ttu-id="a6a30-525">MixedRealityToolkit. Gltf. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-525">MixedRealityToolkit.Examples.Demos.Gltf.asmdef</span></span> | <span data-ttu-id="a6a30-526">MixedReality. Gltf. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-526">Microsoft.MixedReality.Toolkit.Demos.Gltf.asmdef</span></span> |
| <span data-ttu-id="a6a30-527">MixedRealityToolkit，例如 StandardShader asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-527">MixedRealityToolkit.Examples.Demos.StandardShader.Inspectors.asmdef</span></span> | <span data-ttu-id="a6a30-528">MixedReality. StandardShader. asmdef。</span><span class="sxs-lookup"><span data-stu-id="a6a30-528">Microsoft.MixedReality.Toolkit.Demos.StandardShader.Inspectors.asmdef</span></span> |
| <span data-ttu-id="a6a30-529">MixedRealityToolkit，InspectorFields. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-529">MixedRealityToolkit.Examples.Demos.Utilities.InspectorFields.asmdef</span></span> | <span data-ttu-id="a6a30-530">MixedReality. InspectorFields. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-530">Microsoft.MixedReality.Toolkit.Demos.InspectorFields.asmdef</span></span> |
| <span data-ttu-id="a6a30-531">MixedRealityToolkit，例如 InspectorFields asmdef。</span><span class="sxs-lookup"><span data-stu-id="a6a30-531">MixedRealityToolkit.Examples.Demos.Utilities.InspectorFields.Inspectors.asmdef</span></span> | <span data-ttu-id="a6a30-532">MixedReality. InspectorFields. asmdef。</span><span class="sxs-lookup"><span data-stu-id="a6a30-532">Microsoft.MixedReality.Toolkit.Demos.InspectorFields.Inspectors.asmdef</span></span> |
| <span data-ttu-id="a6a30-533">MixedRealityToolkit，例如 Interactables. asmdef</span><span class="sxs-lookup"><span data-stu-id="a6a30-533">MixedRealityToolkit.Examples.Demos.UX.Interactables.asmdef</span></span> | <span data-ttu-id="a6a30-534">MixedReality. Interactables. asmdef。</span><span class="sxs-lookup"><span data-stu-id="a6a30-534">Microsoft.MixedReality.Toolkit.Demos.UX.Interactables.asmdef</span></span> |
