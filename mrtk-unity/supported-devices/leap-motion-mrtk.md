...
使用閏運動 Data Provider 取得接點等同于 MRTK 清楚的手上的聯合抓取。  如需詳細資訊，請參閱 [手動追蹤](../features/input/hand-tracking.md#polling-joint-pose-from-handjointutils)。
