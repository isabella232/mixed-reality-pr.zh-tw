...
2. 請務必勾選 [_功能_] 下的 [ _GazeInput_ ] 核取方塊。 如果您沒有看到「 _GazeInput_ 」功能，請確認您的系統符合 [使用 MRTK](https://docs.microsoft.com/windows/mixed-reality/develop/install-the-tools) (的必要條件，尤其是 Windows SDK 版本) 。
