...
### <a name="eye-supported-positioning"></a>[**目視支援的定位**](../input/eye-tracking/eye-tracking-positioning.md)
...
為了在裝置上使用這些眼睛追蹤範例，請務必在 Visual Studio 中建立應用程式之前，先遵循 [這些步驟](../input/eye-tracking/eye-tracking-basic-setup.md#testing-your-unity-app-on-a-hololens-2) 。
